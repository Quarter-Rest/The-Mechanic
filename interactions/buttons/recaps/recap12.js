...
module.exports = {
	...
	async execute(interaction) {
		...
		var prompt = `Create a bullet point recap for the following messages keep it to less than 750 characters (including formatting) and summarize as needed to meet this requirement and ignore unimportant information such as random comments or numbers starting with "In the last twelve hours, ":\n`;
