...
module.exports = {
	...
	async execute(interaction) {
		...
		var prompt = `Create a bullet point recap for the following messages keep it to less than 1000 characters (including formatting) and summarize as needed to meet this requirement starting with "In the last twelve hours, ":\n`;
