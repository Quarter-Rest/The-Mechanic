...
module.exports = {
	...
	async execute(interaction) {
		...
		var prompt = `Create a bullet point recap for the following messages keep the response length less than 1900 characters so that it may be sent as a message starting with "In the last four hours, ":\n`;
