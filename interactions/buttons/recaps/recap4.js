...
module.exports = {
	...
	async execute(interaction) {
		...
		var prompt = `Create a bullet point recap for the following messages keep it to less than 2000 characters (including formatting) starting with "In the last four hours, ":\n`;
