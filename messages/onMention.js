...
module.exports = {
	...
	async execute(message) {
        ...
        var prompt = currentPers + `Respond to the prompt keep the response length less than 1900 characters so that it may be sent as a message: \'${message.content.substring(22)}\'`;
