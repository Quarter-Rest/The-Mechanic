...
function getToolSystemPrompt() {
    return [
        ...
        'For "what channel are we in", call get_channel with no channel_id to use current channel.',
        'For "tell me about @user" or personality/profile requests, use resolve_user then get_user_profile (and activity tools only if asked).',
        'Never mention internal tool names (for example get_server_stats, get_user_profile, web_search) in user-facing responses.',
